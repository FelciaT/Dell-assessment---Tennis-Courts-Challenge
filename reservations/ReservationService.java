...
public class ReservationService {
    ...
    // Book a reservation at a schedule
...
//        throw new UnsupportedOperationException();
    ...
    public ReservationDTO rescheduleReservation(Long previousReservationId, Long scheduleId) {
        ...
        if (scheduleId.equals(previousReservation.getSchedule().getId())) {
            Long prevScheduleId = findReservation(previousReservationId).getSchedule().getId();
            if(scheduleId.equals(prevScheduleId)) {
                throw new IllegalArgumentException("Cannot reschedule to the same slot.");
            }
        }

        Reservation prevReservation = cancel(previousReservationId);
        previousReservation.setReservationStatus(ReservationStatus.RESCHEDULED);
        reservationRepository.save(prevReservation);
